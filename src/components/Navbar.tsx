...
export default function Navbar({
  ...
  const selectedLinkStyles =
    "text-lg sm:text-xl md:text-2xl font-sans text-tron-yellow cursor-pointer font-bold";
  const unselectedLinkStyles =
    "text-lg sm:text-xl md:text-2xl font-sans text-tron-blue cursor-pointer";
