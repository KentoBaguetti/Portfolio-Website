		...
		>
			...
			>
					<div className="flex flex-col p-3">
						...
						<div className="p-8">
							<p>
								My name is <b>Kentaro Barnes (バーンズ健太郎)</b>. I&#39;m a third year CS student at the University of British Columbia, Aspiring Software Engineer, and I like to develop stuff I find interesting.
							</p>
							<br />
							<div>
								<p className="font-bold">Things I like to learn and talk about:</p>
								<ul className="list-disc px-6">
									...
									<li>Football</li>
									<li>Music <a className="underline" rel="noopener noreferrer" target="_blank" href="https://open.spotify.com/user/8f5idvcxsyo4kjio8mtzmgkly">(Check out my spotify)</a></li>
								</ul>
							</div>
							<br />
							<div>
							...
							<br />
							<div>
								<p>Some random stats to read if you&#39;re a nerd (To clarify, I am not a nerd):</p>
								<ul className="list-disc px-6">
									<li>Leetcode Questions Solved: {total}</li>
									<li>Perfect Soft boiled egg cooking record: 6 min 23 seconds</li>
