				...
				<div className="flex flex-col p-3">
						...
						<div className="p-8">
							<div>
								...
								<div>
									<ul className="list-disc pl-6">
											<li>Researched for viable database solutions to be integrated with the current infrastructure</li>
								...
								<div>
									<ul className="list-disc pl-6">
											...
											<li>Persevered through harsh exam conditions and optimized my thought to action speeds by 200%</li>
									</ul>
								</div>
								</div>
							</div>
